...
//159430/1500018/2.50/5/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOT95P280X145-5N" (originalName "SOT95P280X145-5N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.812 1.475) (pt 0.812 1.475) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.812 1.475) (pt 0.812 -1.475) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -0.812 0.525) (pt 0.138 1.475) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(symbolDef "MCP6291T-E_OT" (originalName "MCP6291T-E_OT")
	...
	(compDef "MCP6291T-E_OT" (originalName "MCP6291T-E_OT") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP6291T-E_OT"))
		...
		(attr "Manufacturer_Part_Number" "MCP6291T-E/OT")
		(attr "Description" "Single 10MHz OpAmp,MCP6291T-E/OT")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/SFDatasheet-4/sf-00090098.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "MCP6291T-E_OT.stp")
